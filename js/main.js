...
class Item {
    constructor(el, img = 'http://placeimg.com/200/150/tech') {
    ...
    render() {
        return `<div class="product-card col-sm" data-id="${this.id_product}">
...
class CartItem extends Item {
    ...
    render() {
        return `<div class="cart-item" data-id="${this.id_product}">
                ...
                <p class="product-price">${this.quantity * this.price} р.</p>
